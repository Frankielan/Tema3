...
import es.upm.dit.adsw.trenes.tramos.RectoH;
...
public class Escenario2 {
    ...
    public static void main(String[] args) {
        ...
        Monitor tunel = new MonitorTunel(cambio23, cambio43);
        tunel.monitoriza(cambio23, Enlace.N, Enlace.W);
        tunel.monitoriza(cambio43, Enlace.N, Enlace.E);
